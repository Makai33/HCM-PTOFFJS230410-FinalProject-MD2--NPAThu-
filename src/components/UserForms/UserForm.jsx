      ...
      <form
        ...
        onSubmit={(event) => {
          ...
          let newUser = {
            ...
            block:
              props.dataForm.preData != null
                ? props.dataForm.preData.block
                : false,
          };
      ...
      >
        ...
        <div className="input-group mb-3">
          ...
          <input
            ...
            name="userName"
            defaultValue={
              props.dataForm.preData != null ? props.dataForm.preData.name : ""
            }
          />
        </div>
        {/* Input User Email */}
        <div className="input-group mb-3">
          ...
          <input
            ...
            name="userEmail"
            defaultValue={
              props.dataForm.preData != null ? props.dataForm.preData.email : ""
            }
          />
        </div>
        ...
        <div className="input-group mb-3">
          ...
          <input
            ...
            defaultValue={
              props.dataForm.preData != null
                ? props.dataForm.preData.phoneNumber
                : ""
            }
          />
        </div>
